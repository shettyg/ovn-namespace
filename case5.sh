...
ports @lrp -- lport-add bar rp-bar

ovn-nbctl set Logical_port rp-bar type=router options:router-port=bar \
...
# bar1 can ping alice1 and alice1 receives traffic from 30.0.0.1
